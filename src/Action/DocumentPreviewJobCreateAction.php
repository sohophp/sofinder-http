...
final class DocumentPreviewJobCreateAction implements MutationActionInterface
{
    public function __construct(private readonly DocumentPreviewJobService $service, private readonly MutationGuard $guard) {}
